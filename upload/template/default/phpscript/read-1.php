...
if ($_G['USER']['ID'] == 1 || InArray(getUserQX(), 'admin') || $_G['TEMP']['BKADMIN'] || ($_G['USER']['ID'] == $readuserdata['id'] && $_G['USER']['ID'])) {
	...
	if (InArray(getUserQX(), 'delread')) {
		$_G['TEMP']['READADMINLINK'] .= '&nbsp;<a href="javascript:" onclick="pkalert(&quot;确认删除该文章？&quot;,&quot;提示&quot;,&quot;window.open(\'index.php?c=delete&table=read&id=' . $_G['GET']['ID'] . '&chkcsrfval=' . $_G['CHKCSRFVAL'] . '\',\'pk-di\');location.href=\'index.php?c=list&rnd=\'+Math.random()&quot;)">删除</a>';
	}
}

...
<img class="ImageLoading pk-max-width-all pk-cursor-pointer" src="template/default/img/loading.gif" data-src="' . $value . '" alt="" onclick="LookImage(this)" />
</div>';
		}
	}
	$i = count($imgshtml);
...
<a href="javascript:" onclick="pkalert(&quot;确认删除该文章？&quot;,&quot;提示&quot;,&quot;window.open(\'index.php?c=delete&table=read&id=' . $readdata['id'] . '&chkcsrfval=' . $_G['CHKCSRFVAL'] . '\',\'pk-di\');$(\'#listdivbox-' . $readdata['id'] . '\').remove()&quot;)">删除</a>
';
}

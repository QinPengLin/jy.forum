...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1506580892, '1', './data/template/1_1_common_header_connect_login.tpl.php', './template/default', 'common/header_connect_login')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1506580892, '1', './data/template/1_1_common_header_connect_login.tpl.php', './template/default', 'common/header_connect_login')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1506580892, '1', './data/template/1_1_common_header_connect_login.tpl.php', './template/default', 'common/header_connect_login')
;?>

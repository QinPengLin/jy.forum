...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1506581712, '1', './data/template/1_1_common_header.tpl.php', './template/default', 'common/header')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1506581712, '1', './data/template/1_1_common_header.tpl.php', './template/default', 'common/header')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1506581712, '1', './data/template/1_1_common_header.tpl.php', './template/default', 'common/header')
;?>

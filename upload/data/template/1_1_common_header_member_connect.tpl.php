...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1506585518, '1', './data/template/1_1_common_header_member_connect.tpl.php', './template/default', 'common/header_member_connect')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1506585518, '1', './data/template/1_1_common_header_member_connect.tpl.php', './template/default', 'common/header_member_connect')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1506585518, '1', './data/template/1_1_common_header_member_connect.tpl.php', './template/default', 'common/header_member_connect')
;?>
